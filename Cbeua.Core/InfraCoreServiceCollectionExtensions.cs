    ...
    public static class InfraCoreServiceCollectionExtensions
    {
             public static IServiceCollection AddInfraCoreServiceCollectionExtensions(this IServiceCollection services, IConfiguration configuration)
        {
           ...
           services.AddScoped<IDesignationRepository, DesignationRepository>();
            ...
            services.AddScoped<IHRMDesignationRepository, HRMDesignationRepository>();
            services.AddScoped<IHRMDocumentTypeRepository, HRMDocumentTypeRepository>();
            ...
            services.AddScoped<IHRMJobTypeRepository, HRMJobTypeRepository>();
            services.AddScoped<IHRMJobCategoryRepository, HRMJobCategoryRepository>();
            services.AddScoped<IHRMCandidateSourceRepository, HRMCandidateSourceRepository>();
            services.AddScoped<IHRMJobRepository, HRMJobRepository>();
            services.AddScoped<IHRMInterviewTypeRepository, HRMInterviewTypeRepository>();
            services.AddScoped<IHRMCandidateRepository, HRMCandidateRepository>();
            services.AddScoped<IHRMJobLocationRepository, HRMJobLocationRepository>();
            services.AddScoped<IHRMSLeaveTypeRepository, HRMSLeaveTypeRepository>();
            services.AddScoped<IHRMSLeaveApplicationRepository, HRMSLeaveApplicationRepository>();
