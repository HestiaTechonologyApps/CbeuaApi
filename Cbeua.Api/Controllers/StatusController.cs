...
namespace Cbeua.Api.Controllers
{
    ...
    public class StatusController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<CustomApiResponse> Create([FromBody] Status status)
        {
            var response = new CustomApiResponse();
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<CustomApiResponse> Update(int id, [FromBody] Status status)
        {
            var response = new CustomApiResponse();
