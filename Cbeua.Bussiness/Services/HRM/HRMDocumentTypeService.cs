...
{
    public class HRMDocumentTypeService : IHRMDocumentTypeService
    {
        private readonly IHRMDocumentTypeRepository _repo;
        private readonly IAuditRepository _auditRepository;
        private readonly ICurrentUserService _currentUser;
        public string AuditTableName { get; set; } = "HRM_DocumentType";

        public HRMDocumentTypeService(
            IHRMDocumentTypeRepository repo,
        ...
        public async Task<List<HRMDocumentTypeDTO>> GetAllAsync(bool ShowDeleted = false, bool ShowInactive = true)
        {
        ...
        public async Task<HRMDocumentTypeDTO?> GetByIdAsync(int id)
        {
            var entities = await _repo.GetQuerableList();
        ...
        public async Task<CustomApiResponse> CreateAsync(HRMDocumentTypeCreateUpdateDTO entitydto)
        {
            try
            {
                var entity = new HRMDocumentType
                {
                    Name = entitydto.Name,
        ...
        public async Task<CustomApiResponse> UpdateAsync(HRMDocumentTypeCreateUpdateDTO entitydto)
        {
            try
            {
                ...
                if (entity == null || entity.IsDeleted)
                    return ApiResponseFactory.Fail(
                        "Document Type not found or already deleted",
        ...
        public async Task<PagedResult<HRMDocumentTypeDTO>> GetPagedAsync(HRMDocumentTypePaginationParams parameters)
        {
            ...
            return new PagedResult<HRMDocumentTypeDTO>
            {
                Data = pagedData,
        ...
        private HRMDocumentType CloneEntity(HRMDocumentType entity) => new HRMDocumentType
        {
            Id = entity.Id,
            Name = entity.Name,
