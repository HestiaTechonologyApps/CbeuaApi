...
{
    public class HRMAwardTypeService : IHRMAwardTypeService
    {
        private readonly IHRMAwardTypeRepository _repo;
        private readonly IAuditRepository _auditRepository;
        private readonly ICurrentUserService _currentUser;
        public string AuditTableName { get; set; } = "HRM_AwardType";

        public HRMAwardTypeService(
            IHRMAwardTypeRepository repo,
        ...
        public async Task<List<HRMAwardTypeDTO>> GetAllAsync(bool ShowDeleted = false, bool ShowInactive = true)
        {
        ...
        public async Task<HRMAwardTypeDTO?> GetByIdAsync(int id)
        {
            var entities = await _repo.GetQuerableList();
        ...
        public async Task<CustomApiResponse> CreateAsync(HRMAwardTypeCreateUpdateDTO entitydto)
        {
            try
            {
                var entity = new HRMAwardType
                {
                    Name = entitydto.Name,
        ...
        public async Task<CustomApiResponse> UpdateAsync(HRMAwardTypeCreateUpdateDTO entitydto)
        {
            try
            {
                ...
                if (entity == null || entity.IsDeleted)
                    return ApiResponseFactory.Fail(
                        "Award Type not found or already deleted",
        ...
        public async Task<PagedResult<HRMAwardTypeDTO>> GetPagedAsync(HRMAwardTypePaginationParams parameters)
        {
            ...
            return new PagedResult<HRMAwardTypeDTO>
            {
                Data = pagedData,
        ...
        private HRMAwardType CloneEntity(HRMAwardType entity) => new HRMAwardType
        {
            Id = entity.Id,
            Name = entity.Name,
