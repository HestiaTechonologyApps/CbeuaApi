...
{
    public class HRMSJobTypeService : IHRMSJobTypeService
    {
        private readonly IHRMSJobTypeRepository _repo;
        private readonly IAuditRepository _auditRepository;
        private readonly ICurrentUserService _currentUser;
        public string AuditTableName { get; set; } = "HRMS_JobTypes";

        public HRMSJobTypeService(
            IHRMSJobTypeRepository repo,
        ...
        public async Task<List<HRMSJobTypeDTO>> GetAllAsync(bool ShowDeleted = false, bool ShowInactive = true)
        {
        ...
        public async Task<HRMSJobTypeDTO?> GetByIdAsync(int id)
        {
            var entities = await _repo.GetQuerableList();
        ...
        public async Task<CustomApiResponse> CreateAsync(HRMSJobTypeCreateUpdateDTO entitydto)
        {
            try
            {
        ...
        public async Task<CustomApiResponse> UpdateAsync(HRMSJobTypeCreateUpdateDTO entitydto)
        {
            try
            {
        ...
        public async Task<PagedResult<HRMSJobTypeDTO>> GetPagedAsync(HRMSJobTypePaginationParams parameters)
        {
            ...
            return new PagedResult<HRMSJobTypeDTO>
            {
                Data = pagedData,
